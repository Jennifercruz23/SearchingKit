...
#[derive(Debug)]
pub struct SearchingProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SearchingProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting Searching processing");
    
    let mut processor = SearchingProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SearchingProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SearchingProcessor::new(false);
